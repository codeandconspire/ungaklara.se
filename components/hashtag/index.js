    ...
    var children = html`
      <svg class="Hashtag-image" width="250" height="250" viewBox="0 0 250 250">
        <g fill="none" fill-rule="nonzero">
          <path id="${this.local.id}-path" d="M125.5 216a90.5 90.5 0 1 1 0-181 90.5 90.5 0 0 1 0 181zm0-1a89.5 89.5 0 1 0 0-179 89.5 89.5 0 0 0 0 179z"/>
        </g>
        <text width="250" height="250" class="Hashtag-text">
          <textPath alignment-baseline="top" xlink:href="#${this.local.id}-path">
            #${text}
          </textPath>
        </text>
      </svg>
