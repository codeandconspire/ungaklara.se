			...
			<footer class="Footer u-container" id="${this.local.id}">
						...
						<div>
							<div class="Footer-cols">
															...
															return html`
																<li class="Footer-item">
																	<a class="Footer-link" href="${url}"
																		>${item.link_text || asText(link.data.title)}</a
																	>
																</li>
															`;
														})
								...
								<div class="Footer-section">
									...
									<ul>
										${doc.data.phone
											? html`
													<li class="Footer-item">
														<a class="Footer-link" href="tel:${doc.data.phone}"
															>${doc.data.phone}</a
														>
													</li>
											  `
										...
										${doc.data.email
											? html`
													<li class="Footer-item">
														<a class="Footer-link" href="mailto:${doc.data.email}"
															>${doc.data.email}</a
														>
													</li>
											  `
											: null}
										${doc.data.contact_page.id && !doc.data.contact_page.isBroken
											? html`
													<li class="Footer-item">
														<a class="Footer-link" href="${resolve(doc.data.contact_page)}"
															>${text`Staff`}</a
														>
													</li>
											  `
								...
								<div class="Footer-section">
									...
									<ul>
										${doc.data.platforms.map(
											(data) => html`
												<li class="Footer-item">
													<a class="Footer-link" target="_blank" href="${data.link.url}"
														>${data.platform}</a
													>
												</li>
											`
				...
				<div class="u-sizeFull u-textCenter">
					<a class="Footer-logo" href="/" rel="home"
						>U<span class="Footer-extra">nga </span>K<span class="Footer-extra">lara</span></a
					>
				</div>
			</footer>
		`;
